            ...
            <div class="col-md-12">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <!-- form start -->                    
                    <?php echo form_open_multipart(base_url().'addNewItem');?>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="type" name="type" class="form-control required" >
                                            <optgroup label="--Select Type--">
                                                ...
                                                <option value="<?php echo $type['id'] ?>"><?php echo $type['code'] ?></option>
                                                <?php endforeach; ?>
                                            </optgroup>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="os" name="os" class="form-control required" >
                                            <optgroup label="--Select OS--">
                                                ...
                                                <option value="<?php echo $os['id'] ?>"><?php echo $os['code'] ?></option>
                                                <?php endforeach; ?>
                                            </optgroup>
                                        </select>
                                    </div>
