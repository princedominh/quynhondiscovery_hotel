                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            if (!empty($referenceRecords)) {
                                foreach ($referenceRecords as $record) {
                                    ?>
                                    <tr>
                                        <td><?php echo $record->provider ?></td>
                                        <td><?php echo $record->content ?></td>
                                        <td>
                                            <a href="<?php echo base_url() . 'referenceEdit/' . $record->id; ?>"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;</a>
                                            <a href="#" data-itemid="<?php echo $record->id; ?>" class="deleteReference"><i class="fa fa-trash"></i>&nbsp;&nbsp;&nbsp;</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
