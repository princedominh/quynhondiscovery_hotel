        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/destination/create">Create Destination</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">References List</h3>
                        <div class="box-tools">
                        ...
                        <table class="table table-hover">
                            ...
                            if (!empty($destinations)) {
                                foreach ($destinations as $record) {
                                    ?>
                                    <tr>
                                        <td><?php for($i=0; $i<$record->level; $i++) echo "-----";?><?php echo $record->name ?></td>
                                        <td><?php echo $record->type ?></td>
                                        <td><?php echo $record->description ?></td>
                                        <td>
                                            <a href="<?php echo base_url() . 'admin/destination/edit/' . $record->id; ?>"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;</a>
...
//            jQuery("#searchList").submit();
	jQuery(document).on("click", ".deleteItem", function(){
		var itemId = $(this).data("itemid"),
                    hitURL = baseURL + "admin/destination/delete",
                    currentRow = $(this);
